...
const Filters = .{ git_status, git_branch, git_show, GitLogCompact, git_diff, git_commit, git_blame, cargo_test, jest, tsc, go_test, pytest, kubectl_compact, docker_compact, npm_install, tree, ls_compact, FindCompactPipe, DuCompactPipe, CurlCompactPipe, GenericCompactPipe };
